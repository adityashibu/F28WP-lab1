...
btn.addEventListener("click", function(){
    ...
    ourRequest.open('GET', 'https://adwii-iii.github.io/F28WP-lab1/week4/cities1.json');
...
function renderHTML(data) {
    ...
    for (i = 0; i < data.length; i++) {
        htmlString += "<p> <strong>" + data[i].name + "</strong> is a city in <strong>" + data[i].country + "</strong> ,<br> \nWhere you can enjoy indoor places like: ";
